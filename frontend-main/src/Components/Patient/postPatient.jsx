...
import TakeAppoint from "./takeappoint";
import PatNavbar from "./patnav";

function SelectDeptDoctorforPatient() {
  ...
  if (doctor && Object.keys(doctor).length !== 0) {
    return <TakeAppoint doctor={doctor} department={department} />;
  }
...
export default SelectDeptDoctorforPatient;
