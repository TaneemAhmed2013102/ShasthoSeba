...
function Reports(props){
  ...
  const userToken = localStorage.getItem("userToken");
    ...
    const [reportsPosted, setReportsPosted] = useState(false);
...
const handleSubmit = async (e) => {
  ...
  let response = await axios.post(baseUrl + "/user/reports/new", body,{
  ...
  return(
    <>
      ...
      <div style={{marginTop: "170px"}}>
        <h5><center><b>Upload Reports</b></center></h5>
